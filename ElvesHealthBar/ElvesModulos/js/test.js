import BlueElf from './componentes/BlueElf.js';
import GreenElf from './componentes/GreenElf.js';
...
class test extends Phaser.Scene {
    ...
    update(){
        if(bluesAlive == 0){
            this.add.text(100, 16, 'Ganaron los verdes!!', { fontSize: '80px', fill: '#1b8522', fontFamily: "Times New Roman" });
            return;
        }
        
        if(greensAlive == 0){
            this.add.text(100, 16, 'Ganaron los azules!!', { fontSize: '80px', fill: '#0D1992', fontFamily: "Times New Roman" });
            return;
        }
    }
